...
#table(
  ...
  [Разработка программы], [Предварительная разработка\ структуры программы;\ Программирование и отладка\ программы], [Готовое приложение, реализующее все функции, определенные в техническом задании], [05.12.24 --\ 27.03.25],
